...
<template>
  <footer class="relative overflow-hidden bg-navy text-white/70">
    <div class="absolute -top-32 left-1/2 -translate-x-1/2 w-[60rem] h-[40rem] rounded-full bg-gold/10 blur-[180px] pointer-events-none"></div>
    ...
    <div class="relative mx-auto max-w-6xl px-5 py-16 md:py-24">
      <div class="flex flex-col gap-10 md:flex-row md:items-end md:justify-between">
        <div class="max-w-md">
          <span class="font-display font-extrabold text-3xl md:text-4xl tracking-tight text-white">
      ...
      <div class="my-12 h-px w-full bg-gradient-to-r from-transparent via-white/15 to-transparent"></div>

      <div class="grid gap-10 md:grid-cols-3">
        <div class="space-y-2 text-sm leading-relaxed">
          <p class="text-white font-semibold text-base mb-3">Реквизиты</p>
          <p>ИП Калиниченко Ольга Вячеславовна</p>
        ...
        <div class="space-y-2 text-sm">
          <p class="text-white font-semibold text-base mb-3">Контакты</p>
          <a href="tel:+79644403172" class="block hover:text-gold-soft transition-colors">+7 (964) 440-31-72 — Андрей</a>
          <a href="tel:+79046278686" class="block hover:text-gold-soft transition-colors">+7 (904) 627-86-86 — Ольга</a>
          <p>Пн–Пт, 10:00–19:00</p>
          <a href="#contacts" class="block hover:text-gold-soft transition-colors">Адрес и карта →</a>
        </div>

        <div class="space-y-3 text-sm">
          <p class="text-white font-semibold text-base mb-3">Документы</p>
          <a href="/privacy.html" class="block hover:text-gold-soft transition-colors">Политика конфиденциальности</a>
          <div class="flex gap-3 pt-3">
            <a href="https://t.me/avtomobil1244" target="_blank" rel="noopener" aria-label="Telegram"
            ...
            <a href="https://2gis.ru/vladivostok/firm/70000001114765329" target="_blank" rel="noopener" aria-label="2GIS"
               class="flex h-11 w-11 items-center justify-center rounded-full border border-white/15 hover:border-gold/60 hover:text-gold-soft hover:-translate-y-0.5 transition-all text-[10px] font-bold">
              2GIS
            </a>
      ...
      <div class="mt-14 pt-6 border-t border-white/10 text-xs text-white/40 flex flex-col sm:flex-row justify-between gap-2">
        <span>© {{ year }} Genesis Auto. Все права защищены.</span>
        <span>Авто из Китая, Кореи и Японии</span>
      </div>
    </div>
  </footer>
</template>
